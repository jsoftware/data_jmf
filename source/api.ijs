...
NB. depends on structure of A block
NORMAH=: 7
'HADK HADFLAG HADM HADT HADC HADN HADR HADS'=: SZI*i.NORMAH+1

HADRUS=: HADR+IFBE*IF64{2 6 NB. address of rank US bytes
HSN=: NORMAH+64    NB. jmf header size in JINTs
...
allochdr=: 3 : '([ 2&setHADC^:initc) 15!:8 y'
...
HAD=: HAD"_`(((15!:9 ] 01 memw ,&(HADT,1,JINT)) ] memr@(,&(0,NORMAH,JINT)))@(15!:8))@.(_1 = 4!:0 <'HAD') 0  NB. empty A block header
